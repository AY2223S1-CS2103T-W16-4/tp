...
import seedu.myinsurec.commons.core.Config;
import seedu.myinsurec.commons.core.LogsCenter;
import seedu.myinsurec.commons.core.Version;
import seedu.myinsurec.commons.exceptions.DataConversionException;
import seedu.myinsurec.commons.util.ConfigUtil;
import seedu.myinsurec.commons.util.StringUtil;
import seedu.myinsurec.logic.Logic;
import seedu.myinsurec.logic.LogicManager;
...
import seedu.myinsurec.model.util.SampleDataUtil;
import seedu.myinsurec.storage.JsonMyInsuRecStorage;
import seedu.myinsurec.storage.JsonUserPrefsStorage;
import seedu.myinsurec.storage.MyInsuRecStorage;
import seedu.myinsurec.storage.Storage;
import seedu.myinsurec.storage.StorageManager;
import seedu.myinsurec.storage.UserPrefsStorage;
import seedu.myinsurec.ui.Ui;
import seedu.myinsurec.ui.UiManager;
...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing MyInsuRec ]===========================");
        super.init();
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting MyInsuRec " + MainApp.VERSION);
        ui.start(primaryStage);
    }

    @Override
    public void stop() {
        logger.info("============================ [ Stopping MyInsuRec ] =============================");
        try {
