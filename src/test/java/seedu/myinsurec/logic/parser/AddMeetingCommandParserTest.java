...
import static seedu.myinsurec.logic.commands.CommandTestUtil.INVALID_DATE_DESC;
import static seedu.myinsurec.logic.commands.CommandTestUtil.INVALID_END_TIME_DESC;
import static seedu.myinsurec.logic.commands.CommandTestUtil.INVALID_START_TIME_DESC;
import static seedu.myinsurec.logic.commands.CommandTestUtil.MEETING_DESC_MEETING1;
import static seedu.myinsurec.logic.commands.CommandTestUtil.VALID_DATE_MEETING1;
import static seedu.myinsurec.logic.commands.CommandTestUtil.VALID_DESCRIPTION_MEETING1;
import static seedu.myinsurec.logic.commands.CommandTestUtil.VALID_END_TIME_MEETING1;
import static seedu.myinsurec.logic.commands.CommandTestUtil.VALID_START_TIME_MEETING1;
import static seedu.myinsurec.logic.parser.CliSyntax.PREFIX_DATE;
import static seedu.myinsurec.logic.parser.CliSyntax.PREFIX_DESCRIPTION;
import static seedu.myinsurec.logic.parser.CliSyntax.PREFIX_END_TIME;
import static seedu.myinsurec.logic.parser.CliSyntax.PREFIX_INDEX;
import static seedu.myinsurec.logic.parser.CliSyntax.PREFIX_START_TIME;
...
import seedu.myinsurec.logic.commands.AddMeetingCommand;
import seedu.myinsurec.model.meeting.Meeting;
import seedu.myinsurec.model.meeting.MeetingDate;
import seedu.myinsurec.model.meeting.MeetingTime;
