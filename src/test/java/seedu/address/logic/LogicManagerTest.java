...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonMyInsuRecStorage addressBookStorage =
                new JsonMyInsuRecStorage(temporaryFolder.resolve("addressBook.json"));
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        JsonMyInsuRecStorage addressBookStorage =
                new JsonMyInsuRecIoExceptionThrowingStub(temporaryFolder.resolve("ioExceptionAddressBook.json"));
